...
export { RES, FPS, PLAYER_POS, PLAYER_ANGLE, PLAYER_SPEED, PLAYER_ROT_SPEED, FOV, HALF_FOV, NUM_RAYS, HALF_NUM_RAYS, DELTA_ANGLE, MAX_DEPTH, SCREEN_DIST, SCALE,HALF_HEIGHT }